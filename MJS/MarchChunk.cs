...
public class MarchChunk : MonoBehaviour
{
	MarchingCubesBurst mcb;
	public int3 gridSize; //Amount of nodes.
	public float iso; //Minimum terrain density.
	public float dx; //Voxel size.
	...
	void Start()
	{
		...
		//float isoValue = 1.5f; //What is isoValue?
		mcb.computeIsoSurface(iso);
